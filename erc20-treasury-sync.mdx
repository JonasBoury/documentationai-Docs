...
description: >-
  Synchronize incoming and outgoing operations from various sources against a
  treasury token
---
## Intro
...
<Image uid="3924e38b-4c2a-4eed-bf56-297e88a615a3" src="https://blob-cdn.documentation.ai/org-f9a33560-cb9b-4d66-b66c-511f736111a4/doc-b72060e3-2226-4e90-913e-c19fe16e0465/1763326283512-nf93zip82vp-ERC20-Treasury-Sync-Image.png" width="1024" height="1536" alt="" />

## Treasuries

A treasury = 🏢 business + 🪙 token.
...
For example: As soon as you receive €10, mint 10 tokens to the corresponding account.
...
For example: Every month, on the 15th, check if at least €150 were received from a specific account since the last sync. If the target was reached, mint 150 tokens to the corresponding account.
